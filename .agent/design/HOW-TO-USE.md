...
```
.agent/design/
├── design-system.md          # Your main style guide
...
### Step 3: Document in design-system.md
Open `design-system.md` and add your reference:
...
> "Build me a hero section like the one in design-system.md under Hero Sections"
...
> "Use the color palette from design-system.md"
> "Match the typography in design-system.md"
...
After 3-4 projects, you'll have a consistent style. Document it in `design-system.md` so every project feels cohesive.

### 5. Link Everything
Use markdown links to connect:
- Components to their code files: `[see code](file:///path/to/component.tsx)`
- Screenshots to design-system.md
...
3. **Request the build**:
   > "Build a hero section matching the 'Dark Animated Hero' reference in design-system.md"
...
4. Suggest updates to design-system.md and component-library.md
